...
const About = () => {
  return (
    <section id="about" className="min-h-[90vh] py-24">
      <h2 className="h2 text-apple-800">About TreeLawn</h2>
      <div className="rm-container grid lg:grid-cols-2 items-center justify-evenly gap-12">
        ...
        <div className="flex-1 flex flex-col items-start gap-4 max-w-lg">
          <h3 className="uppercase text-2xl md:text-3xl text-mucky-800/90 font-extrabold tracking-wide border-l-8 border-apple-800/90 pl-2">
