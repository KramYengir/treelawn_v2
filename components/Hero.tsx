...
const Hero = () => {
  return (
    ...
    >
      <div className="rm-container w-full flex flex-col lg:flex-row items-start lg:items-center justify-evenly gap-x-12  text-balance">
        <div className="flex-1 flex flex-col items-start justify-center gap-y-4 pb-8 lg:pb-0 max-w-md md:max-w-lg lg:max-w-2xl">
        ...
        <div className="flex-1 flex flex-col items-start justify-center gap-x-12 gap-y-6 pt-8 lg:pt-0 border-t-2 lg:border-0 border-mucky-50/40 max-w-lg">
